...
export default function HomePage() {
  ...
  const [role, setRole] = useState('Landlord / Property Owner');
  ...
  async function submit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setEmail('');
      setName('');
      setRole('Landlord / Property Owner');
    } catch (err: unknown) {
    ...
    <main className="bg-gradient-to-br from-[#14213D] to-[#1F1F1F] text-white">
      ...
      <header className="sticky top-0 inset-x-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-black/20 bg-black/10 border-b border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 h-14 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <Image src="/logo1.png" width={28} height={28} alt="Conexus" priority />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-10 sm:py-12 lg:py-16">
          <div className="grid lg:grid-cols-2 gap-10 items-start">
            ...
            <div className="order-2 lg:order-1">
              ...
              {/* Trust metrics */}
              <div className="grid grid-cols-3 gap-3 sm:gap-4 max-w-xl mb-5">
                <div className="rounded-2xl border border-white/10 bg-white/5 p-3 sm:p-4 text-center">
                  <div className="text-xl sm:text-2xl font-extrabold text-white">300+</div>
                  <div className="text-[11px] sm:text-xs text-white/70">Early access units</div>
                </div>
                <div className="rounded-2xl border border-white/10 bg-white/5 p-3 sm:p-4 text-center">
                  <div className="text-xl sm:text-2xl font-extrabold text-white">5</div>
                  <div className="text-[11px] sm:text-xs text-white/70">Major TX metros</div>
                </div>
                <div className="rounded-2xl border border-white/10 bg-white/5 p-3 sm:p-4 text-center">
                  <div className="text-xl sm:text-2xl font-extrabold text-white">Built With</div>
                  <div className="text-[11px] sm:text-xs text-white/70">Contractor feedback</div>
                </div>
              </div>
              ...
              <form onSubmit={submit} className="flex flex-wrap items-center gap-3" aria-label="Join waitlist form">
                <input
                  ...
                  className="min-w-[220px] flex-1 rounded-xl border border-white/15 bg-white/5 px-4 py-3 text-white placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-[#F0A202]"
                />
                <input
                  type="email"
                  inputMode="email"
                  ...
                  className="min-w-[240px] flex-1 rounded-xl border border-white/15 bg-white/5 px-4 py-3 text-white placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-[#F0A202]"
                />
                <select
                  value={role}
            ...
            <div className="order-1 lg:order-2">
              <div className="rounded-3xl bg-white/5 p-4 sm:p-6 border border-white/10">
                ...
                {/* Auto-sizes to container; great on phones + desktops */}
                <PhoneDemo />
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl border border-white/10 p-6 bg-white/5">
              ...
              <ul className="text-white/85 space-y-2">
                ...
                <li>• Unreliable labor and rescheduling</li>
      ...
      <section className="bg-[#081022] text-white" id="why-conexus">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-14">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { title: 'Instant dispatch', body: 'Jobs route to qualified, available pros in minutes — not days. No phone tag, no guesswork.' },
              { title: 'Vetted contractor network', body: 'License + insurance checks, track records, and performance scores. Use our pros or bring your own.' },
              { title: 'Transparent payments', body: 'Clear pricing, digital approvals, and instant payouts when work is verified. No hidden fees.' },
              { title: 'SLA automation', body: 'ETAs, follow‑ups, and escalations handled for you. Hit your SLAs without spreadsheets.' },
              { title: 'Portfolio analytics', body: 'See trends by property, unit, and category. Predict costs and cut time‑to‑resolution.' },
              { title: 'Modern tenant UX', body: 'Simple mobile flows with photo/video evidence and status updates tenants actually read.' },
            ].map((item) => (
      ...
      <section className="bg-[#0E1528] text-white" id="faq">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-14">
          ...
          <div className="space-y-3">
            <details className="rounded-xl border border-white/10 bg-white/5 p-4">
              ...
              <div className="mt-2 text-white/85 space-y-2">
                <p>
                  ...
                  SLA automation, approvals, and payments end‑to‑end — no manual coordination or spreadsheet wrangling.
                  Compared to traditional PM software, Conexus delivers live contractor matching, tenant‑first mobile flows,
                  and verified payouts.
                </p>
            ...
            <details className="rounded-xl border border-white/10 bg-white/5 p-4">
              <summary className="cursor-pointer font-semibold">What are your fees?</summary>
            ...
            <details className="rounded-xl border border-white/10 bg-white/5 p-4">
              <summary className="cursor-pointer font-semibold">Contractors — when do I get paid and how?</summary>
              <p className="mt-2 text-white/85">
                Once work is approved (with photo/video proof), payouts are released instantly to your
                connected account. A downpayment will be provided with the rest awarded after job completion.
                Most banks settle within 1–2 business days.
              </p>
            </details>

            <details className="rounded-xl border border-white/10 bg-white/5 p-4">
              <summary className="cursor-pointer font-semibold">Can I use my own contractors?</summary>
              <p className="mt-2 text-white/85">
            ...
            <details className="rounded-xl border border-white/10 bg-white/5 p-4">
              <summary className="cursor-pointer font-semibold">How are funds handled and protected?</summary>
              <p className="mt-2 text-white/85">
            ...
            <details className="rounded-xl border border-white/10 bg-white/5 p-4">
              <summary className="cursor-pointer font-semibold">Where are you launching first?</summary>
              <p className="mt-2 text-white/85">
            ...
            <details className="rounded-xl border border-white/10 bg-white/5 p-4">
              <summary className="cursor-pointer font-semibold">How do you vet contractors?</summary>
              <p className="mt-2 text-white/85">
            ...
            <details className="rounded-xl border border-white/10 bg-white/5 p-4">
              <summary className="cursor-pointer font-semibold">What if a job isn’t done right?</summary>
              <p className="mt-2 text-white/85">
            ...
            <details className="rounded-xl border border-white/10 bg-white/5 p-4">
              <summary className="cursor-pointer font-semibold">How fast is dispatch?</summary>
              <p className="mt-2 text-white/85">
      ...
      <section id="waitlist" className="bg-white text-[#1F1F1F]">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 py-12 sm:py-14 text-center">
          ...
          <form onSubmit={submit} className="flex flex-wrap items-center justify-center gap-3" aria-label="Join waitlist form (footer)">
            ...
            <input
              ...
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              className="min-w-[240px] rounded-xl border border-black/10 bg-white px-4 py-3"
            />
            <select
              value={role}
              onChange={(e) => setRole(e.target.value)}
            ...
            <button
              type="submit"
              disabled={status === 'loading'}
              className="rounded-xl bg-[#14213D] px-5 py-3 font-bold text-white hover:opacity-90 transition disabled:opacity-60"
            >
              {status === 'loading' ? 'Joining…' : 'Join the Waitlist'}
            </button>
          </form>
